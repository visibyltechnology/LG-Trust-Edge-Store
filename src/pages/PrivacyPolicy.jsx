...
export default function PrivacyPolicy() {
  return (
    <main className="min-h-screen flex flex-col bg-gray-50">
      <SEO title="Privacy Policy | LG Trust Edge" description="Learn about how LG Trust Edge collects, uses, and protects your personal information." />
      <div className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        {/* Header */}
        <div className="mb-10">
          <div className="inline-flex items-center gap-2 text-xs font-bold text-[#E2001A] uppercase tracking-widest mb-4">
        ...
        <div className="bg-white border border-gray-200 rounded-sm p-6 mb-6 shadow-sm">
          <p className="text-sm text-gray-700 leading-relaxed font-medium">
            LG Trust Edge ("we", "our", "us") is committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website{' '}
        ...
        <div className="space-y-4">
          {[
                ...
                <>
                  ...
                  <ul className="space-y-2">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-2 text-sm">
                        <i className="fas fa-angle-right text-[#E2001A] mt-0.5 flex-shrink-0"></i>
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
            ...
            },
            {
              ...
              title: 'Data Security',
              content: (
                <p>We implement appropriate technical and organisational security measures to protect your personal data against accidental loss, unauthorised access, and disclosure. Your account password is hashed and never stored in plain text. Payment data is processed entirely through Korapay's PCI-DSS compliant infrastructure — LG Trust Edge does not store your card details on our servers.</p>
              )
            },
            {
              number: '5',
              ...
              content: (
                <>
                  ...
                  <p className="mt-3 text-sm">To exercise any of these rights, contact us at <strong>support@LG Trust Edgeworld.com.ng</strong>.</p>
                </>
              )
            },
            {
            ...
            <div key={section.number} className="bg-white border border-gray-200 rounded-sm shadow-sm overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-100 bg-gray-50 flex items-center gap-3">
                <span className="w-7 h-7 rounded-full bg-[#E2001A] flex items-center justify-center text-xs font-black flex-shrink-0 text-white">
                  {section.number}
                </span>
                <div className="flex items-center gap-2">
                  <i className={`fas ${section.icon} text-[#E2001A] text-xs`}></i>
