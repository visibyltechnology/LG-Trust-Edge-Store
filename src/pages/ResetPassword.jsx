          ...
          <div className="bg-white border border-gray-200 shadow-lg rounded-2xl overflow-hidden">
            ...
            <div className="px-8 py-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-center gap-2 mb-4">
                    {otp.map((data, index) => (
                      <input
                        ...
                        className="w-10 h-12 text-xl text-center border border-gray-300 focus:border-lg-dark outline-none rounded-xl font-black bg-gray-50 focus:bg-white text-lg-dark transition-all shadow-sm"
                      />
                    ))}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-10 pr-12 py-3 border border-gray-300 focus:border-lg-dark outline-none text-sm font-medium transition-colors rounded-2xl bg-gray-50 focus:bg-white"
                    />
                    <button
                      type="button"
                ...
                <button type="submit" disabled={loading} className="w-full bg-lg-dark hover:bg-blue-900 disabled:opacity-60 text-white font-black py-4 rounded-2xl uppercase tracking-widest text-sm transition-all flex items-center justify-center gap-3 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                  {loading ? (
