      ...
      <div className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        ...
        <div className="bg-white border border-gray-200 rounded-sm p-6 mb-6 shadow-sm">
          <p className="text-sm text-gray-700 leading-relaxed font-medium">
            Welcome to <strong className="text-gray-900">LG Trust Edge!</strong> These Terms and Conditions ("Terms") govern your use of our website located at{' '}
            <a href="https://www.LG Trust Edgeworld.com.ng" className="text-[#E2001A] hover:underline font-bold">https://www.LG Trust Edgeworld.com.ng</a>{' '}
        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              content: (
                <>
                  ...
                  <p><strong className="text-gray-900">Authorization:</strong> By submitting an order, you authorize LG Trust Edge (via Korapay) to charge your designated payment method for the total amount of your order, including applicable taxes (such as VAT) and delivery fees.</p>
                </>
              )
            },
            {
              ...
              content: (
                <>
                  <p className="mb-3"><strong className="text-gray-900">Shipping Estimates:</strong> Delivery dates given at checkout are estimates only and cannot be guaranteed. LG Trust Edge is not liable for delays caused by local dispatch services, interstate logistics tracking issues, or factors beyond our control.</p>
                  <p><strong className="text-gray-900">Risk of Loss:</strong> All physical items purchased from LG Trust Edge are made pursuant to a shipment contract. The risk of loss and title for such items pass to you upon our delivery to the courier/logistics partner.</p>
                </>
              )
            },
            {
              ...
              content: (
                <>
                  <div className="bg-red-50 border border-red-200 rounded-sm p-4 mb-4">
                    <p className="text-red-800 font-bold text-sm"><i className="fas fa-exclamation-circle mr-2"></i>All sales on LG Trust Edge are final. We enforce a strict No-Return and No-Refund policy once an item has been purchased and successfully dispatched or delivered.</p>
                  </div>
                  ...
                  <p><strong className="text-gray-900">Manufacturer Warranties:</strong> Many electronics sold on LG Trust Edge come with an official manufacturer's warranty. LG Trust Edge itself does not provide additional store warranties. For any technical faults or defects discovered after delivery, your sole remedy is to contact the manufacturer's authorized service center in Nigeria under their warranty terms.</p>
                </>
              )
            },
            {
              ...
              content: (
                <p>All content on this Site — including text, graphics, logos, button icons, images, digital downloads, and software — is the property of LG Trust Edge or its content suppliers and is protected by Nigerian and international copyright, trademark, and intellectual property laws.</p>
              )
            },
            {
              number: '7',
              ...
              content: (
                <>
                  <p className="mb-3">To the maximum extent permitted by applicable Nigerian law, LG Trust Edge, its directors, employees, or affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to:</p>
                  ...
                  <p>Our total liability for any claim arising out of these Terms shall not exceed the amount you paid to LG Trust Edge for the specific product in question.</p>
                </>
              )
            },
            {
            ...
            },
            {
              ...
              content: (
                <p>LG Trust Edge reserves the right to update or modify these Terms at any time without prior notice. The "Last Updated" date at the top of this page will indicate when changes were made. Your continued use of the Site following any changes constitutes your acceptance of the new Terms.</p>
              )
            },
            {
              number: '11',
              ...
              content: (
                <>
                  ...
                  <ul className="space-y-1.5 text-sm font-medium">
                    <li><i className="fas fa-envelope mr-2 text-[#E2001A]"></i><strong>Email:</strong> support@LG Trust Edgeworld.com.ng</li>
                    <li><i className="fas fa-phone mr-2 text-[#E2001A]"></i><strong>Phone:</strong> +234 708 044 1764</li>
                    <li><i className="fas fa-map-marker-alt mr-2 text-[#E2001A]"></i><strong>Address:</strong> 77 Olu-Obasanjo Road Port Harcourt, Rivers State, Nigeria</li>
                  </ul>
                </>
              )
            },
